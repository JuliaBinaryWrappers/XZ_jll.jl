...
export lzmadec, xzdec, xz, lzmainfo, liblzma
...
const lzmadec_splitpath = ["bin", "lzmadec.exe"]
...
const xzdec_splitpath = ["bin", "xzdec.exe"]
...
const lzmainfo_splitpath = ["bin", "lzmainfo.exe"]
...
const liblzma_splitpath = ["bin", "liblzma-5.dll"]
